...
schedule.every().day.at("13:00").do(job, 'It is 13:00')
schedule.every().day.at("14:00").do(job, 'It is 14:00')
schedule.every().day.at("15:00").do(job, 'It is 15:00')
schedule.every().day.at("16:00").do(job, 'It is 16:00')
schedule.every().day.at("17:00").do(job, 'It is 17:00')
schedule.every().day.at("18:00").do(job, 'It is 18:00')
schedule.every().day.at("19:00").do(job, 'It is 19:00')
schedule.every().day.at("20:00").do(job, 'It is 20:00')
schedule.every().day.at("21:00").do(job, 'It is 21:00')
